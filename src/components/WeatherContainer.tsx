...
windSpeed:fetchedData.wind.speed + "m/s",
    ...
    return (
    <main className="w-96 rounded-3xl bg-gradient-to-b from-blue-800  to-purple-700 shadow-lg border-spacing-1">
      {error === "" ? (
...
<div className="flex justify-center items-center h-50 text-white font-bold text-xl p-4 text-center">
{error}
</div>
      )}
